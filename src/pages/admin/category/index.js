                            ...
                            ${data.map((category, index) => `
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="/admin/category/${category.id}/edit" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        <button data-id="${category.id}" class="btn btn-delete bg-indigo-600 hover:bg-indigo-900 px-4 py-3 text-white rounded-full">Delete</button>
                                    </td>
                                </tr>
                            `).join("")}
                            </tbody>
